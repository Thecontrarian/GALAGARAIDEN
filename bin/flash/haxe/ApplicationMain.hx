...
class ApplicationMain {
	...
	public static function getAsset (inName:String):Dynamic {
		...
		if (inName=="gfx/diskus.png")
			 
            return Assets.getBitmapData ("gfx/diskus.png");
         
		
		if (inName=="gfx/glow_things.png")
			 
            return Assets.getBitmapData ("gfx/glow_things.png");
         
		
		if (inName=="gfx/needsmoarfeetz.png")
			 
            return Assets.getBitmapData ("gfx/needsmoarfeetz.png");
         
		
		if (inName=="gfx/orbs.png")
			 
            return Assets.getBitmapData ("gfx/orbs.png");
		...
		if (inName=="gfx/rockets.png")
			 
            return Assets.getBitmapData ("gfx/rockets.png");
         
		
		if (inName=="gfx/ships.png")
			 
            return Assets.getBitmapData ("gfx/ships.png");
         
		
		if (inName=="gfx/totem.png")
			 
            return Assets.getBitmapData ("gfx/totem.png");
...
class NME_gfx_diskus_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_gfx_glow_things_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_gfx_needsmoarfeetz_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_gfx_orbs_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_gfx_preloader_haxepunk_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_gfx_rockets_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_gfx_ships_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_gfx_totem_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
